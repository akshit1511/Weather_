...
t = get_temperature (weather_response(location,'cb5980b863904caf30c76a9a617610c5'), 3, '18:00:00')
print("Temperature - ",int(t-273),"C")
print("Humidity - ",get_humidity(weather_response(location,'cb5980b863904caf30c76a9a617610c5'), 3, '12:00:00'))
print("Pressure - ",get_pressure(weather_response(location,'cb5980b863904caf30c76a9a617610c5'), 3, '12:00:00'))
print("Wind Speed - ",get_wind(weather_response(location,'cb5980b863904caf30c76a9a617610c5'), 3, '12:00:00'),'kmph')
print("Sea Level - ",get_sealevel(weather_response(location,'cb5980b863904caf30c76a9a617610c5'), 4, '12:00:00'),'m')
